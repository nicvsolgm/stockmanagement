# Generated by Django 3.1.6 on 2021-02-03 03:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stockmgnt', '0007_stock_timestamp'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='StockHistory',
            fields=[
                ('id', models.AutoField(auto_created=False, primary_key=False, serialize=False, verbose_name='ID')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='stockmgnt.category')),
            ],
        ),
    ]
